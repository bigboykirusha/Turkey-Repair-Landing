(() => {
  ...
  const ae = document.querySelector(".control__video-button"),
    le = document.querySelector(".control__layout"),
    oe = document.querySelector(".control__play");
  oe.addEventListener("click", function () {
    le.classList.remove("video-active"),
